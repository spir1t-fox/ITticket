// Standalone script to create demo user account
...
async function createDemoUser() {
  try {
    ...
    let userRecord;
    try {
      userRecord = await auth.getUserByEmail(DEMO_USER.email);
      console.log('User already exists, updating password and role...');
      await auth.updateUser(userRecord.uid, { password: DEMO_USER.password });
    } catch (error) {
    ...
    console.log('');
    console.log('After setup, delete this file for security');
